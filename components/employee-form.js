class EmployeeForm {
  ...
  editEmployeeForm(name, lastName, position, department_name, salary, id) {
    ...
    let inputNameElement = this.formElement.querySelector(
      "input[type='text'][name='name']"
    );
    let inputLastNameElement = this.formElement.querySelector(
      "input[type='text'][name='lastName']"
    );
    let inputPositionElement = this.formElement.querySelector(
      "input[type='text'][name='position']"
    );
    let inputDepartmentElement = this.formElement.querySelector(
      "input[type='text'][name='department_name']"
    );
    let inputSalaryElement = this.formElement.querySelector(
